  <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <!-- Sidebar - Brand -->
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ url('project/index') }}">
        ...
        <div class="sidebar-brand-text mx-3" ><h4><strong>BOM</strong></h4></div>
      </a>
    ...
    <!-- Heading -->
      <div class="sidebar-heading">
        ...
        {{ Request::is('part') ? 'bg-success' : 'bg-success' }}
         {{ Request::is('bom/', '*') ? 'bg-warning ' : '' }}
         {{ Request::is('bomdetail/', '*') ? 'bg-warning' : '' }}
         {{ Request::is('project/', '*') ? 'bg-warning ' : '' }}">
